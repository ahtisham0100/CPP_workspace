...
int main()
{
    ...
    do {
        ...
        std::cout << "Enter the corresponding number of function you want to perform (for example  for sin)." << std::endl;
           int function;
        std::cin >> function;
...
std::cout<<" ENTER THE NUMBER WHOSE SQUARE ROOT YOU WANT TO CALCULATE." << std::endl;
std::cin>>num;
